...
namespace gl {
    ...
    template <typename T>
    void
    Buffer::setData(const std::vector<T>& data)
    {
        glBufferData(static_cast<GLenum>(getTarget()),
            data.size() * sizeof(T),
            data.data(),
    ...
    template <typename T>
    void
    Buffer::setData(const std::vector<T>& data, Usage usage)
    {
        setUsage(usage);
        setData(data);
    }
    ...
    template <typename T>
    void
    Buffer::setSubData(const std::vector<T>& data, GLintptr offset)
    {
    ...
    template <typename T>
    void
    Buffer::setSubData(const std::vector<T>& data, GLintptr offset, GLsizeiptr size)
    {
